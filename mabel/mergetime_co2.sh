...
path_bin=/usr/bin
path_dat=/dados4/operacao/geos_fp
path_cli=$path_dat/clima
...
#
echo " Período , No Meses -> " $ai$mi a $af$mf , $cont_meses
#
#
########################################################
# Loop Monthly data               		       #
...
do
 ...
 echo "Data Inicio do Processo Mensal:"
 date
 #ls ${path_dat}/${ano}/${mes}/*/AS_geos.chm.*.nc4
 #exit
 file_out=${path_dat}/${ano}/AS_geos.chm.${ano}${mes}.nc4
